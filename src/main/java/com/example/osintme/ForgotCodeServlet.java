...
@WebServlet(name = "ForgotCodeServlet", value = "/forgot-code-servlet")
public class ForgotCodeServlet extends HttpServlet {
    @Override
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // Otherwise, send them the password code
            ...
            try {
                ...
                message.setSubject("Your OSINTMe forgot password code is: " + code);
                message.setText("Hello,\n\nYour OSINTMe forgot password code is: " + code + "\n\n" + "Best,\nOSINTMe");
